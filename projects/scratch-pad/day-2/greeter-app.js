...
function greeter(hour) {
    ...
    if (hour < 12){ // this will be true if the hour is 0-11
        console.log("Good Morning!") // will print Good Morning!
    } else if ( hour < 17){ //this will be true if the hour is 12-16 as 0-11 has been disqualified
        console.log("Good Afternoon!") // will print Good Afternoon!
    } else if (hour < 22){ //this will be true if the hour is 17-21 as 0-16 has been disqualified
        console.log("Good Evening!") // will print Good Evening!
    } else { //This will be the default that will be any other time, so 22-24 will be in this catigory
        console.log("Good Night!") // will print Good Night!
    }
